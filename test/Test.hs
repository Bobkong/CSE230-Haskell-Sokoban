...
judgeManChangeDirectionTest w = assertBool "test Man move direction"
    $ DirectDown == direct (head $ man (processManTryMove DirectDown w))

judgeManMoveBlockedTest :: World -> Assertion
judgeManMoveBlockedTest w = assertBool "test Man move with obstacles"
